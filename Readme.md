...
###4. Crappy linkage error like "undefined reference to `GdsParser::read(GdsParser::GdsDataBaseKernel&, std::string const&)'" under gcc 5.1 or later, even though libgdsparser.a is correctly linked. 
